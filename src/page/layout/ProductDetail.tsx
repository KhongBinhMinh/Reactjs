...
const ProductDetail = (props: Props) => {
  ...
  <div>
    <div x-data="{ cartOpen: false , isOpen: false }" className="bg-white">
      ...
      <div class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" className="fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300">
        <div className="flex items-center justify-between">
          <h3 className="text-2xl font-medium text-gray-700">Your cart</h3>
          <button  className="text-gray-600 focus:outline-none">
            <svg className="h-5 w-5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" stroke="currentColor"><path d="M6 18L18 6M6 6l12 12" /></svg>
          </button>
        </div>
        <hr className="my-3" />
      ...
      <main className="my-8">
        <div className="container mx-auto px-6">
          <div className="md:flex md:items-center">
            ...
            <div className="w-full max-w-lg mx-auto mt-5 md:ml-1 md:mt-2 md:w-1/8">
